...
This file contains full remediation entry blocks moved out of `REMEDIATION.md` after status reached `Done` or `Won't fix`.

Append-only rule: keep moved blocks verbatim and add newer moves at the end.
